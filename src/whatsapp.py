                        ...
                        if file.filename.endswith(".txt"):
                            ...
                            with package.open(file.filename, mode="r") as msg:
                                ...
                                for message in tqdm(messages, leave=False):
                                    ...
                                    total_chr += nb_chars
                                    total_msg += 1
                                avg_delay_you = sum(delays_you, timedelta()) / len(
                                    delays_you) if delays_you else timedelta(0)
                                avg_delay_oth = sum(delays_oth, timedelta()) / len(
                                    delays_oth) if delays_oth else timedelta(0)
